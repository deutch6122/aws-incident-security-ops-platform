"""SQLAlchemy models aligned with db/migrations/0001_init_schema.sql."""
...
class IncidentComment(Base):
    ...
    __table_args__ = (Index("idx_incident_comments_incident_id", "incident_id"),)
...
class AuditLog(Base):
    ...
    __table_args__ = (Index("idx_audit_logs_entity", "entity_type", "entity_id"),)

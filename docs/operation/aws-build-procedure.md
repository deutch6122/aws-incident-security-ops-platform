...
export WORKER_DB_SECRET_ARN=＜ECS migration task definitionのBACKEND_DB_SECRET_ARN＞
export WORKER_DB_HOST=＜aurora.cluster_endpoint＞
export WORKER_DB_PORT=＜aurora.port＞
export WORKER_DB_NAME=＜aurora.database_name＞
